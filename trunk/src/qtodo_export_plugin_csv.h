...
#ifndef QTODO_EXPORT_PLUGIN_CSV
#define QTODO_EXPORT_PLUGIN_CSV

class QTodoExportPluginCSV : QTodoExportPluginBase
{
	public:
	void doExport();
	...
	static QTodoExportPluginBase* get() { if(!instance) { return instance = new QTodoExportPluginCSV(); } else { return instance; } };
	...
	QTodoExportPluginCSV();

	static QTodoExportPluginBase* instance;

	int elements_in_cur_row;
	int current_id;
};
